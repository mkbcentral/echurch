                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3  @error('started_date') is-invalid border border-danger rounded @enderror">
                                    ...
                                    <x-datepicker class="form-control datetimepicker-input"
                                         wire:model.defer='state.started_date' id="startedDateEvent"/>
                                    @error('state.started_date') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div> 
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 @error('finished_date') is-invalid border border-danger rounded @enderror">
                                    ...
                                    <x-datepicker class="form-control datetimepicker-input"
                                         wire:model.defer='state.finished_date' id="finishedDateEvent"/>
                                    @error('finished_date') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div> 
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 
                                 @error('started_time') is-invalid border border-danger rounded @enderror">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text">
                                    ...
                                    <x-timepicker class="form-control datetimepicker-input"
                                         wire:model.defer='state.started_time' id="startedTimeEvent"/>
                                    @error('state.started_time') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div> 
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 @error('finished_time') is-invalid border border-danger rounded @enderror">
                                    ...
                                    <x-timepicker class="form-control datetimepicker-input"
                                         wire:model.defer='state.finished_time' id="finishedTimeEvent"/>
                                    @error('finished_time') <span class="error text-danger">{{ $message }}</span> @enderror
                                </div> 
                            </div>
