...
window.addEventListener('show-meke-online-confirmation-preaching', function (event) {
...
window.addEventListener('data-valided', function (event) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire('Oprétion !', event.detail.message, 'success');
}); //MAKE IS ONLINE CHURCH DIALOG

window.addEventListener('show-meke-online-confirmation-church', function (event) {
  sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
    title: 'Are-you sure ',
